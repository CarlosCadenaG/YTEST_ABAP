*&---------------------------------------------------------------------*
*& Report  ZABAP_BUSCAR_EXIT
*&
*&---------------------------------------------------------------------*
*&
*&
*&---------------------------------------------------------------------*
REPORT  zabap_buscar_exit NO STANDARD PAGE HEADING LINE-SIZE 201.
*&--------------------------------------------------------------------&*
...
SELECTION-SCREEN SKIP.
PARAMETER: p_devc  type c LENGTH 30 DEFAULT ' ' MODIF ID a01,
           p_func  type c LENGTH 30 DEFAULT ' ' MODIF ID a01,
           p_subm  type c LENGTH 30 DEFAULT ' ' MODIF ID a01.
*LIKE rihea-dy_ofn
*LIKE rihea-dy_ofn
*LIKE rihea-dy_ofn
